@tool
@icon("res://GUI/DialogSystem/icons/cutscene_player.svg")
...
func play() -> void:
	...
	if scale_animation_with_movement:
		var animation_speed_scale : float = move_speed / animation_speed_factor
		player.animation_player.speed_scale = animation_speed_scale
